...
def get_rhombus_type(a=0, b=0, c=0, d=0):
    """
    Determine if the given dimensions/angles constitute a square, rectangle,
    rhombus, or no polygon
    ...
    :return: "square", "rectangle", "rhombus", "disconnected object" or "invalid"
    :rtype: str
    """
    ...
    elif (a + b == c + d or a + c == b + d) and a + b + c + d != 360:
        return "rectangle"

    elif a + b + c + d == 360:
        return "rhombus"
    else:
        return "disconnected object"